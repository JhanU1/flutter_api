...
class FormUser extends StatelessWidget {
  ...
  onInit() {
    if (_userRx.value != null) {
      _nameController.text = _userRx.value!.name;
      _lastNameController.text = _userRx.value!.lastName;
      _userNameController.text = _userRx.value!.userName;
      _passwordController.text = _userRx.value!.password;
      _emailController.text = _userRx.value!.email;
      _urlImageController.text = _userRx.value!.urlImage;
      _descriptionController.text = _userRx.value!.description;
    }
  }
